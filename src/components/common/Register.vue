	...
	<div class="content">
		...
		<div class="right">
			...
			<div class="form-wrappepr">
				<input type="text" class="inputs userId" v-model="useracc" name="useracc" placeholder="请输入账号"
				...
				<button type="submit" @click="register()">Sigin In</button>
			</div>
		</div>
	</div>
</template>
...
<script>
	export default {
		...
		methods: {
			register() {
				console.log("注册操作执行-------");
								this.$axios.post(this.$httpUrl+'/user/register' , this.$qs.stringify({
