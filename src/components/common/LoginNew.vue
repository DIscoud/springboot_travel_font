	...
	<div class="content">
		...
		<div class="right">
			...
			<div class="form-wrappepr">
				<h1>Login</h1>
				<input type="text" class="inputs user" name="username" v-model="stuId" placeholder="输入您的账号"
				 required >
				<input type="password" class="inputs pwd" name="password" v-model="password" placeholder="输入您的密码" required>
