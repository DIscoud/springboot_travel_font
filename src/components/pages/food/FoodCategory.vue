    ...
    <div>
        <el-card class="box-card" style="width: 1600px; margin: 20px auto">
            ...
            <el-table :data="tableData" :header-cell-style="{ background: 'rgb(232,244,255)', color: '#555' }" border>
                <el-table-column prop="categoryId" label="美食分类Id" width="480" align="center">
                </el-table-column>
                <el-table-column prop="categoryName" label="美食分类名称" width="480" align="center">
                </el-table-column>
                <el-table-column prop="rutTime" label="创建时间" width="380" align="center">
                </el-table-column>
                <el-table-column prop="operate" label="管理" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button type="danger" size="small" icon="el-icon-delete"
                            @click="del(scope.row.categoryId)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
